...
function clickHandler(){
    ...
    document.getElementById("img").innerHTML = `<img src="./image/STOCKS-NORMAL.png" alt="stock profit">`;
    ...
    if(growth === 0){
        ...
        document.getElementById("img").innerHTML = `<img src="./image/stock-loss.png" alt="stock profit">`;
        }
    }
        ...
        if(growthPercentage > 50)
        document.getElementById("img").innerHTML = `<img src="./image/stock-profit.png" alt="stock profit">`;
